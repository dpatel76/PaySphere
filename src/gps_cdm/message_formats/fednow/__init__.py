...
class FedNowExtractor(BaseExtractor):
    ...
    def extract_gold_entities(
        ...
        """Extract Gold layer entities from FedNow Silver record.
        ...
        # Debtor Agent
        if silver_data.get('debtor_agent_routing'):
            entities.financial_institutions.append(FinancialInstitutionData(
                role="DEBTOR_AGENT",
                clearing_code=silver_data.get('debtor_agent_routing'),
                clearing_system='FEDNOW',
                country='US',
            ))

        # Creditor Agent
        if silver_data.get('creditor_agent_routing'):
            entities.financial_institutions.append(FinancialInstitutionData(
                role="CREDITOR_AGENT",
                clearing_code=silver_data.get('creditor_agent_routing'),
                clearing_system='FEDNOW',
                country='US',
            ))
