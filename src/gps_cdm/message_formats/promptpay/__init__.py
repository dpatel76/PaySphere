...
class PromptPayParser:
    """Parser for PromptPay JSON format messages.
    ...
    def parse(self, raw_content: str) -> Dict[str, Any]:
        ...
        result['currency'] = data.get('currency') or 'THB'
        ...
        result['payerCountry'] = payer_addr.get('country') or 'TH'
        ...
        result['payeeCountry'] = payee_addr.get('country') or 'TH'
...
class PromptPayExtractor(BaseExtractor):
    ...
    def get_silver_columns(self) -> List[str]:
        ...
        return [
            ...
            'payer_tax_id', 'payer_bank_name', 'payer_bank_bic', 'payer_account_type',
            'payee_tax_id', 'payee_bank_name', 'payee_bank_bic', 'payee_account_type',
    ...
    def extract_gold_entities(
        ...
        if silver_data.get('payer_name'):
            ...
            entities.parties.append(PartyData(
                ...
                identification_type='TAXID' if silver_data.get('payer_tax_id') else payer_proxy_type,
        ...
        if silver_data.get('payee_name'):
            ...
            entities.parties.append(PartyData(
                ...
                role="CREDITOR",
                party_type=party_type,
                identification_type='TAXID' if silver_data.get('payee_tax_id') else payee_proxy_type,
