# AUSTRAC IFTI - International Funds Transfer Instruction
## Complete Field Mapping to GPS CDM

**Report Type:** International Funds Transfer Instruction (IFTI)
**Regulatory Authority:** AUSTRAC (Australian Transaction Reports and Analysis Centre)
**Filing Requirement:** Report all international funds transfer instructions (inbound and outbound)
...
The IFTI report is required under the Anti-Money Laundering and Counter-Terrorism Financing Act 2006 (AML/CTF Act). Reporting entities must submit an IFTI for every international funds transfer instruction they send or receive.

**Filing Threshold:** All international funds transfers, regardless of amount
**Filing Deadline:** Within 10 business days after the instruction is sent or received
...
|--------|-------|------------|
| **Total IFTI Fields** | 87 | 100% |
| **Mapped to CDM** | 87 | 100% |
| **Direct Mapping** | 79 | 91% |
...
| Field# | Field Name | Type | Length | Required | Valid Values | CDM Entity | CDM Attribute | Notes |
|--------|------------|------|--------|----------|--------------|------------|---------------|-------|
| B1 | Direction of transfer | Code | 1 | Yes | 1=Inbound, 2=Outbound | PaymentInstruction | transferDirection | Direction of funds flow |
...
### Ordering Institution (Section C) - Sending for Outbound, Receiving for Inbound

| Field# | Field Name | Type | Length | Required | Valid Values | CDM Entity | CDM Attribute | Notes |
|--------|------------|------|--------|----------|--------------|------------|---------------|-------|
| C1 | Ordering institution name | Text | 200 | Yes | Free text | FinancialInstitution | orderingInstitutionName | Sending bank |
...
### Beneficiary Institution (Section D) - Receiving for Outbound, Sending for Inbound

| Field# | Field Name | Type | Length | Required | Valid Values | CDM Entity | CDM Attribute | Notes |
|--------|------------|------|--------|----------|--------------|------------|---------------|-------|
| D1 | Beneficiary institution name | Text | 200 | Yes | Free text | FinancialInstitution | beneficiaryInstitutionName | Receiving bank |
...
### Ordering Customer (Section E) - Sender/Originator
...
### Beneficiary Customer (Section F) - Receiver/Beneficiary
...
| - | Channel used | Code | 1 | PaymentInstruction | channelCode | SWIFT, correspondent, etc. |
...
All 87 IFTI fields successfully map to existing CDM model. **No enhancements required.**
...
Section C - Ordering Institution (CBA - Australian bank sending)
...
Section D - Beneficiary Institution (JPMorgan - US bank receiving)
D1: JPMorgan Chase Bank
D2: US
D3: CHASUS33XXX
D5: 270 Park Avenue
D6: New York
...
Section E - Ordering Customer (Australian company sending)
E1: O (Organization)
...
Section F - Beneficiary Customer (US company receiving)
F1: O (Organization)
